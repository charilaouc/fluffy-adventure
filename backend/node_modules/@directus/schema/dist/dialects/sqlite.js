...
var sqlite_1 = __importStar(require("knex-schema-inspector/dist/dialects/sqlite"));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                        ...
                        for (_a = 0, columns_1 = columns; _a < columns_1.length; _a++) {
                            ...
                            overview[table].columns[column.name] = {
                                ...
                                default_value: column.pk === 1 && tablesWithAutoIncrementPrimaryKeys.includes(table)
                                    ? 'AUTO_INCREMENT'
                                    : (0, sqlite_1.parseDefaultValue)(column.dflt_value),
                                is_nullable: column.notnull == 0,
                                is_generated: column.hidden !== 0,
                                data_type: (0, extract_type_1.default)(column.type),
                                max_length: (0, extract_max_length_1.default)(column.type),
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [2 /*return*/, overview];
                }
            });
        });
    };
