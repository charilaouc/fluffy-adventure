...
exports.getValueForToken = exports.to10 = exports.to36 = exports.decode = exports.encode = exports.mapToSortedArray = exports.decompress = exports.compress = void 0;
var Types;
(function (Types) {
    Types["NULL"] = "null";
        ...
        if (type === '$') {
            ...
            for (; tokenIndex < tokens.length; tokenIndex++) {
                ...
                if (rawValue === '$' || rawValue === '@') {
                    ...
                    const value = (_a = values[rawValue]) !== null && _a !== void 0 ? _a : getValueForToken(rawValue);
                    node[key] = value;
                }
            }
        }
        if (type === '@') {
            ...
            for (; tokenIndex < tokens.length; tokenIndex++) {
                ...
                if (rawValue === '$' || rawValue === '@') {
                    ...
                    const value = (_b = values[tokens[tokenIndex]]) !== null && _b !== void 0 ? _b : getValueForToken(tokens[tokenIndex]);
                    node.push(value);
                }
            }
        }
...
exports.getValueForToken = getValueForToken;
