...
`),l("span",{class:"hljs-keyword"},"export"),e(),l("span",{class:"hljs-keyword"},"default"),e(` ({ filter }, { services, exceptions }) => {
	...
	`),l("span",{class:"hljs-title function_"},"filter"),e("("),l("span",{class:"hljs-string"},"'items.create'"),e(", "),l("span",{class:"hljs-keyword"},"async"),e(` (input, { collection }, { schema }) => {
		`),l("span",{class:"hljs-keyword"},"if"),e(" (collection !== "),l("span",{class:"hljs-string"},"'recipes'"),e(") "),l("span",{class:"hljs-keyword"},"return"),e(` input;

		`),l("span",{class:"hljs-keyword"},"const"),e(" mailService = "),l("span",{class:"hljs-keyword"},"new"),e(),l("span",{class:"hljs-title class_"},"MailService"),e(`({ schema });
