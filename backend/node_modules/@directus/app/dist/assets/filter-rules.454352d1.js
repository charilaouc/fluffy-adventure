...
`)])],-1),U=t("h2",{id:"logical-operators",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#logical-operators"},"#"),n(" Logical Operators")],-1),F=t("p",null,[n("You can nest or group multiple rules using the "),t("code",null,"_and"),n(" or "),t("code",null,"_or"),n(" logical operators. Each logical operator holds an array of Filter Rules, allowing for more complex filtering. Also note in the example that Logical Operators can be sub-nested into Logical Operators. However, they cannot be sub-nested into Filter Rules.")],-1),S=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),n(`
	...
	`),t("span",{class:"hljs-punctuation"},"]"),n(`
`),t("span",{class:"hljs-punctuation"},"}"),n(`
`)])],-1),$=t("h3",{id:"some-vs-none-in-one-to-many",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#some-vs-none-in-one-to-many"},"#"),n(" Some vs None in One-to-Many")],-1),C=t("p",null,"When applying filters to a one-to-many field, Directus will default to a \u201Csome\u201D search, for example in:",-1),L=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),n(`
...
`)])],-1),V=t("p",null,[n("the top level parent will be returned if "),t("em",null,"one of"),n(" the categories has the name "),t("code",null,"Recipe"),n(". This behavior can be overridden by using the explicit "),t("code",null,"_some"),n(" and "),t("code",null,"_none"),n(" operators, for example:")],-1),M=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),n(`
	...
	`),t("span",{class:"hljs-punctuation"},"}"),n(`
`),t("span",{class:"hljs-punctuation"},"}"),n(`
`)])],-1),W=t("p",null,"will fetch all parent items that don\u2019t have the category \u201CRecipe\u201D",-1),A=t("h2",{id:"dynamic-variables",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#dynamic-variables"},"#"),n(" Dynamic Variables")],-1),G=t("p",null,[n("In addition to static values, you can also filter against "),t("em",null,"dynamic"),n(" values using the following variables.")],-1),P=t("ul",null,[t("li",null,[t("code",null,"$CURRENT_USER"),n(" \u2014 The primary key of the currently authenticated user")]),t("li",null,[t("code",null,"$CURRENT_ROLE"),n(" \u2014 The primary key of the role for the currently authenticated user")]),t("li",null,[t("code",null,"$NOW"),n(" \u2014 The current timestamp")]),t("li",null,[t("code",null,"$NOW(<adjustment>)"),n(" - The current timestamp plus/minus a given distance, for example "),t("code",null,"$NOW(-1 year)"),n(", "),t("code",null,"$NOW(+2 hours)")])],-1),B={class:"tip hint"},Y=t("div",{class:"hint-title"},"Functions",-1),J=n("You can also use "),Q=n("Function Parameters"),Z=n(" when building Filters."),z=t("div",{class:"tip hint"},[t("div",{class:"hint-title"},"Nested User / Role variables in Permissions"),t("p",null,[n("When configuring permissions, "),t("code",null,"$CURRENT_USER"),n(" and "),t("code",null,"$CURRENT_ROLE"),n(" allow you to specify any (nested) field under the current user/role as well as the root ID. For example: "),t("code",null,"$CURRENT_ROLE.name"),n(" or "),t("code",null,"$CURRENT_USER.avatar.filesize"),n(". This includes custom fields that were added to the directus_users/directus_roles tables.")]),t("p",null,"Note: This feature is only available for permissions, validation, and presets. Regular filters and conditional fields currently only support the root ID.")],-1),nt="Filter Rules",st=!1,lt="REST and GraphQL API documentation for filter rules in Directus.",at="5 min read",et={name:"filter-rules",setup(H,{expose:e}){const s={title:"Filter Rules",modularExtension:!1,description:"REST and GraphQL API documentation for filter rules in Directus.",readTime:"5 min read"};return e({frontmatter:s}),(K,X)=>{const o=l("router-link"),u=l("docs-wrapper");return c(),i(u,{frontmatter:s},{default:a(()=>[t("div",p,[h,d,j,_,f,m,g,b,y,v,R,w,x,E,T,I,N,O,q,D,k,U,F,S,$,C,L,V,M,W,A,G,P,t("div",B,[Y,t("p",null,[J,r(o,{to:"/docs/reference/query#functions"},{default:a(()=>[Q]),_:1}),Z])]),z])]),_:1})}}};export{et as default,lt as description,st as modularExtension,at as readTime,nt as title};
