...
`),t("span",{class:"hljs-punctuation"},"}"),s(`
`)])],-1),G=t("p",null,[s("This will create a new record in the related collection, and save its primary key in the "),t("code",null,"featured_article"),s(" field for this item. To update an existing item, simply provide the primary key with the updates, and Directus will treat it as an update instead of a creation:")],-1),M=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),s(`
	`),t("span",{class:"hljs-attr"},'"featured_article"'),t("span",{class:"hljs-punctuation"},":"),s(),t("span",{class:"hljs-punctuation"},"{"),s(`
	...
	`),t("span",{class:"hljs-punctuation"},"}"),s(`
`),t("span",{class:"hljs-punctuation"},"}"),s(`
`)])],-1),V=t("p",null,"Seeing that the Many-to-One relationship stores the foreign key on the field itself, removing the item can be done by nullifying the field:",-1),B=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),s(`
...
`)])],-1),X=t("p",null,"You can also provide an object instead of a primary key in order to create new items nested on the fly, or an object with a primary key included to update an existing item:",-1),z=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),s(`
	...
	`),t("span",{class:"hljs-punctuation"},"]"),s(`
`),t("span",{class:"hljs-punctuation"},"}"),s(`
`)])],-1),J=t("p",null,"To remove items from this relationship, simply omit them from the array:",-1),Z=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),s(`
...
`),t("span",{class:"hljs-punctuation"},"}"),s(`
`)])],-1),$=t("p",null,"This method of updating a one-to-many is very useful for smaller relational datasets.",-1),tt=t("p",null,[t("strong",null,"\u201CDetailed\u201D")],-1),st=t("p",null,"Alternatively, you can provide an object detailing the changes as follows:",-1),nt=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),s(`
	`),t("span",{class:"hljs-attr"},'"children"'),t("span",{class:"hljs-punctuation"},":"),s(),t("span",{class:"hljs-punctuation"},"{"),s(`
...
`)])],-1),et=t("p",null,"This is useful if you need to have more tightly control on staged changes, or when you\u2019re working with a big relational dataset.",-1),at=t("h4",{id:"many-to-any-(union-types)",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#many-to-any-(union-types)"},"#"),s(" Many-to-Any (Union Types)")],-1),lt=t("p",null,"Many-to-Any fields work very similar to a \u201Cregular\u201D many-to-many, with the exception that the related field can pull in the fields from any of the related collections, for example:",-1),ot=t("pre",null,[t("code",{class:"language-json"},[t("span",{class:"hljs-punctuation"},"{"),s(`
	...
	`),t("span",{class:"hljs-punctuation"},"]"),s(`
`),t("span",{class:"hljs-punctuation"},"}"),s(`
`)])],-1),it=t("h5",{id:"rest-api",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#rest-api"},"#"),s(" REST API")],-1),ct=t("p",null,[s("To scope the fields that are returned per collection type, you can use the "),t("code",null,"<field>:<scope>"),s(" syntax in the fields parameter as follows:")],-1),rt=t("pre",null,[t("code",null,`GET /items/pages
...
`)],-1),ut=t("h5",{id:"graphql",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#graphql"},"#"),s(" GraphQL")],-1),ht=t("p",null,"In GraphQL, you can use nested fragments on the Union Type to select the fields:",-1),dt=t("pre",null,[t("code",{class:"language-graphql"},[t("span",{class:"hljs-keyword"},"query"),s(` {
	pages {
		sections {
			item {
