...
`)])])],-1),j="Custom API Endpoints",f=!0,m="A guide on how to build custom API endpoints in Directus.",g="3 min read",y={name:"endpoints",setup(p,{expose:t}){const n={title:"Custom API Endpoints",modularExtension:!0,description:"A guide on how to build custom API endpoints in Directus.",readTime:"3 min read"};return t({frontmatter:n}),(u,h)=>{const l=a("docs-wrapper");return o(),r(l,{frontmatter:n},{default:i(()=>[c]),_:1})}}};export{y as default,m as description,f as modularExtension,g as readTime,j as title};
