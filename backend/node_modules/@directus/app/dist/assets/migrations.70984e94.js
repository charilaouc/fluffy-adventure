...
`)])]),s("p",null,[e("You may want to add additional steps to reflect other responsibilities of "),s("code",null,"directus bootstrap"),e(".")])],-1),m="Custom Migrations",g=!1,f="A guide on how to setup your owns custom Migrations in Directus.",b="2 min read",j={name:"migrations",setup(u,{expose:t}){const a={title:"Custom Migrations",modularExtension:!1,description:"A guide on how to setup your owns custom Migrations in Directus.",readTime:"2 min read"};return t({frontmatter:a}),(d,p)=>{const n=o("docs-wrapper");return l(),r(n,{frontmatter:a},{default:i(()=>[c]),_:1})}}};export{j as default,f as description,g as modularExtension,b as readTime,m as title};
