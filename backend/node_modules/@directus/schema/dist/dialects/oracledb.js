...
var oracledb_1 = __importStar(require("knex-schema-inspector/dist/dialects/oracledb"));
var Oracle = /** @class */ (function (_super) {
    ...
    Oracle.prototype.overview = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var columns, overview, _loop_1, _i, columns_1, column;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (column) {
                            ...
                            overview[column.table_name].columns[column.column_name] = __assign(__assign({}, column), { is_nullable: column.is_nullable === 'Y', is_generated: column.is_generated === 'YES', default_value: hasAutoIncrement ? 'AUTO_INCREMENT' : (0, oracledb_1.parseDefaultValue)(column.default_value) });
                        };
