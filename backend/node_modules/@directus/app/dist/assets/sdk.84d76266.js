...
`)])],-1),Ns=s("h3",{id:"read-all",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#read-all"},"#"),a(" Read All")],-1),Us=s("pre",null,[s("code",{class:"language-js"},[s("span",{class:"hljs-keyword"},"await"),a(" articles."),s("span",{class:"hljs-title function_"},"readByQuery"),a(`({
...
`)])],-1),Es=s("h3",{id:"read-single-item",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#read-single-item"},"#"),a(" Read Single Item")],-1),Ks=s("pre",null,[s("code",{class:"language-js"},[s("span",{class:"hljs-keyword"},"await"),a(" articles."),s("span",{class:"hljs-title function_"},"readOne"),a("("),s("span",{class:"hljs-number"},"15"),a(`);
...
`)])],-1),Na=s("p",null,[a("Same methods as "),s("code",null,'directus.items("directus_folders")'),a(".")],-1),Ua=s("h2",{id:"permissions",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#permissions"},"#"),a(" Permissions")],-1),Ea=s("pre",null,[s("code",{class:"language-js"},[a("directus."),s("span",{class:"hljs-property"},"permissions"),a(`;
...
`)])],-1),Nt=s("h3",{id:"sort-items-in-a-collection",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#sort-items-in-a-collection"},"#"),a(" Sort Items in a Collection")],-1),Ut=s("pre",null,[s("code",{class:"language-js"},[s("span",{class:"hljs-keyword"},"await"),a(" directus."),s("span",{class:"hljs-property"},"utils"),a("."),s("span",{class:"hljs-title function_"},"sort"),a("("),s("span",{class:"hljs-string"},"'articles'"),a(", "),s("span",{class:"hljs-number"},"15"),a(", "),s("span",{class:"hljs-number"},"42"),a(`);
