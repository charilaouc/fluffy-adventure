...
`)],-1),K=e("p",null,[o("Write down the IP address (in this example "),e("code",null,"123.456.789.0"),o("), you\u2019ll need to set it in your "),e("code",null,".env"),o(" later")],-1),H=e("ol",{start:"9"},[e("li",null,"Set the root user password in your database:")],-1),F=e("pre",null,[e("code",null,`gcloud sql users set-password root --host=% --instance <database-instance-name> --password <your-safe-root-password> --project=<your-project-id>
`)],-1),z=e("ol",{start:"10"},[e("li",null,"Create the directus database:")],-1),J=e("pre",null,[e("code",null,`gcloud sql databases create directus --instance=<database-instance-name> --project=<your-project-id>
`)],-1),X=e("p",null,[o("In this example the database is called "),e("code",null,"directus")],-1),Z=e("ol",{start:"11"},[e("li",null,"Get the connection name of your CloudSQL instance:")],-1),$=e("pre",null,[e("code",null,`gcloud sql instances describe <database-instance-name> --project=<your-project-id>
`)],-1),ee=e("p",null,[o("You will need the value of "),e("code",null,"connectionName"),o(" in step 12 and 14.")],-1),oe=e("ol",{start:"12"},[e("li",null,[o("Add these items to your "),e("code",null,".env"),o(" file:")])],-1),te=e("pre",null,[e("code",null,`DB_CLIENT="pg"
DB_PORT="5432"
...
`)],-1),ne=e("p",null,"Notes:",-1),le=e("ul",null,[e("li",null,[o("the value of "),e("code",null,"connectionName"),o(" from step 11 should be prefixed with "),e("code",null,"/cloudsql/"),o(" as the value of "),e("code",null,"DB_HOST")]),e("li",null,"Google Cloud Logging variables are optional, but they make Directus logs show up with correct level in Google Cloud Logging.")],-1),se=e("ol",{start:"13"},[e("li",null,"Build your container Run these commands.")],-1),re=e("pre",null,[e("code",null,`docker build -t eu.gcr.io/<your-project-id>/directus .
gcloud auth configure-docker -q
docker push eu.gcr.io/<your-project-id>/directus
`)],-1),ae=e("p",null,"This will build the Docker container, authenticate your docker installation with Google Cloud Platform and push the container image to the container registry in your GCP project.",-1),ie=e("ol",{start:"14"},[e("li",null,"Deploy your container")],-1),ce=e("pre",null,[e("code",null,`gcloud run deploy directus \\
...
`)],-1),ue=e("p",null,[o("Note: the value of "),e("code",null,"connectionName"),o(" from step 11 should be used as the value of "),e("code",null,"add-cloudsql-instances"),o(" without any prefix.")],-1),de=e("ol",{start:"15"},[e("li",null,[o("Done! The deploy command should\u2019ve told you the URL where you can access your Directus instance. You can login with "),e("code",null,"admin@example.com"),o(" and "),e("code",null,"localpassword"),o(".")])],-1),he=e("h2",{id:"additional-improvements",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#additional-improvements"},"#"),o(" Additional improvements")],-1),pe=e("li",null,[o("You should make your CloudSQL instance only accessible through a private IP and VPC connector. This way only your current cloud project is able to access the database. More on this "),e("a",{href:"https://cloud.google.com/sql/docs/postgres/connect-run#private-ip",target:"_blank",rel:"noopener noreferrer"},"here"),o(".")],-1),ge=e("li",null,[o("You should not store your "),e("code",null,".env"),o(" file locally and build it into your Dockerfile. Ideally you should save your "),e("code",null,".env"),o(" file in "),e("a",{href:"https://cloud.google.com/secret-manager",target:"_blank",rel:"noopener noreferrer"},"Google Cloud Secret Manager"),o(" and in your CI/CD pipeline retrieve it and add it to your container. Or, even better, let the container pick the "),e("code",null,".env"),o(" up at runtime from Google Secret Manager.")],-1),_e=e("li",null,[o("Cloud Run typically allocates resources in a request context. Meaning async hooks etc will get drastically less CPU and memory, often even resulting in those processes not completing. You have two options: "),e("a",{href:"https://cloud.google.com/run/docs/configuring/cpu-allocation",target:"_blank",rel:"noopener noreferrer"},"CPU allocation"),o(" that is always allocated (which will increase cost) or handle everything in your extensions synchronously.")],-1),me=o("You could setup "),fe=o("caching"),ye=o(" using "),be=e("a",{href:"https://cloud.google.com/memorystore/docs/redis",target:"_blank",rel:"noopener noreferrer"},"Memorystore for Redis",-1),we=o("Since, by default, Google Cloud Run will scale back to zero instances of the container, it\u2019s impossible to use the "),ke=o("Schedule hooks"),Ce=o(" since there is no container to handle those schedules / cron jobs. Again you have two options: Set the minimum number of instances to 1, this will definitely increase cost as at least 1 container keeps on running 24/7. Or you could use "),Se=e("a",{href:"https://cloud.google.com/scheduler",target:"_blank",rel:"noopener noreferrer"},"Cloud Scheduler",-1),ve=o(" to schedule calls to custom endpoints which will do the tasks."),Ae="Google Cloud Platform",Te=!1,je="How to host Directus on Google Cloud Platform.",Le="6 min read",xe={name:"gcp",setup(Ge,{expose:a}){const s={title:"Google Cloud Platform",modularExtension:!1,description:"How to host Directus on Google Cloud Platform.",readTime:"6 min read"};return a({frontmatter:s}),(De,Re)=>{const n=r("router-link"),i=r("docs-wrapper");return c(),u(i,{frontmatter:s},{default:t(()=>[e("div",d,[h,p,g,_,m,f,y,b,w,k,C,S,v,G,D,R,E,e("ol",null,[A,e("li",null,[e("p",null,[T,l(n,{to:"/docs/self-hosted/installation/manual"},{default:t(()=>[j]),_:1})])]),L]),x,I,P,O,q,N,B,M,W,Q,U,Y,V,K,H,F,z,J,X,Z,$,ee,oe,te,ne,le,se,re,ae,ie,ce,ue,de,he,e("ul",null,[pe,ge,_e,e("li",null,[me,l(n,{to:"/docs/self-hosted/config-options#cache"},{default:t(()=>[fe]),_:1}),ye,be]),e("li",null,[we,l(n,{to:"/docs/extensions/hooks#schedule"},{default:t(()=>[ke]),_:1}),Ce,Se,ve])])])]),_:1})}}};export{xe as default,je as description,Te as modularExtension,Le as readTime,Ae as title};
